...
test_tables() ->
    [
     ...
     {army, 1, 1,  2,  2, [], none, 0, 1, {2,{1,nil,{2,nil,nil}}}, none},
     {army, 2, 1,  5,  5, [], none, 0, 0, {2,{7,nil,{8,nil,nil}}}, none},
     {army, 3, 2,  3,  3, [], none, 0, 0, {1,{9,nil,nil}}, none},
     {army, 4, 3, 10, 10, [], none, 0, 0, {0, nil}, none},
     {army, 5, 4, 15,  2, [], none, 0, 0, {0, nil}, none},
     {army, 6, -1, 3, 1, [], none, 0, 0, {1,{3,nil, nil}}, none},
     {hero, 1, 1, 1},
     {unit, 1, 1, 1, 1, 25, 1},
     {unit, 2, 1, 1, 2, 20, 1},
     {unit, 3, 6, 1, 1, 16, 1},
