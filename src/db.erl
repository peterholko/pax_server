...
test_tables() ->
    [
     ...
     {kingdom, 1, 1, <<"The Rich">>, 5000, [], [11]},
     {kingdom, 2, 2, <<"The Bad">>, 100, [], []},
     {kingdom, 3, 3, <<"The Ugly">>, 100, [], []},
     {kingdom, 4, 4, <<"The Poor">>, 100, [], []},
     {kingdom, -1, -1, <<"The NPC">>, 1000, [], []},
     {player_type, 1, 0},
     {player_type, 2, 0},
     {player_type, 3, 0},
     {player_type, 4, 0},
     ...
     {city, 11, 1,<<"Calgary">>, 3, 4, 0, {0, nil}, {0, nil}, [], 50, 50, 0, 50, 50, 50, 0},
     ...
     {item, 9997, {{?OBJECT_CITY, 11}, 1}, 1036, -1, 10000000},
     {item, 9996, {{?OBJECT_CITY, 11}, 1}, 1035, -1, 100000},
     ...
     {item_type_ref, {{?OBJECT_CITY, 11}, 1, 1036}, 9997},
